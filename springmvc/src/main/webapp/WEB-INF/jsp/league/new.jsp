...
<jsp:attribute name="body">
    ...
    <form:form method="post" action="${pageContext.request.contextPath}/league/create"
        ...
        <div class="form-group">
            <form:label path="country" cssClass="col-sm-2 control-label"><f:message key="country"/></form:label>
            <div class="col-sm-10">
        ...
        <button class="btn btn-primary" type="submit"><f:message key="createLeague"/></button>
    </form:form>
