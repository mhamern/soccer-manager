...
public class LeagueController {
    ...
    public String view(@PathVariable long id, Model model) {
        ...
        model.addAttribute("matches", matchFacade.getMatchesByLeague(id));

        List<TeamDTO> leagueTable = leagueFacade.calculateLeagues(id);
        leagueTable.sort(
                Comparator.<TeamDTO> comparingInt(team -> team.getPoints()).reversed()
                        .thenComparingInt(team -> team.getGoalsScored()).reversed()
                        .thenComparingInt(team -> team.getGoalsConceded()).reversed());
